...
namespace BrandBrand
{
    static class Damage
    {
        ...
        static Damage()
        {
            ...
            BonusDamage.Add(SpellSlot.Q, new[] { 0.55f, 0.55f, 0.55f, 0.55f, 0.55f });
        ...
        public static float GetBlazeRemainingDamage(Obj_AI_Base unit)
        {
            ...
            var count = unit.GetBuffCount("BrandAblaze");
            ...
            return Player.Instance.CalculateDamageOnUnit(unit, DamageType.Magical,
                unit.MaxHealth * 0.005f * count * (float)Math.Floor(buff.EndTime - Game.Time));
        }
